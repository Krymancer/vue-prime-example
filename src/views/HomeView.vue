      ...
      <div v-else>
        <div class="relative overflow-x-auto border border-gray-200 rounded-lg">
          <table class="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
              <tr class="bg-white border-b" v-for="employee in employees" :key="employee.employeeID">
                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                  <strong>{{ employee.employeeID }}</strong>
                </th>
                <td class="px-6 py-4 font-bold">
                  <span class="text-red-400" v-if="employee.status === 'I'">Inactive</span>
                  <span class="text-green-400" v-else>Active</span>
                </td>
                <td class="px-6 py-4">
                  {{ employee.adUserID }}
                </td>
